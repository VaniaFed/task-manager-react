...
export const Header = ({ className }: Props) => {
	...
	const resultClass = cx('header', className);
	return (
		<header className={resultClass}>
			<nav className="header__nav container container_size_1168">
				<a href="#" target="_blank">
					<svg className="header__logo" viewBox="-8.86 0 89.724 89.724" xmlns="http://www.w3.org/2000/svg">
				...
				<ul className="header__links">
					<li>
						<a className="header__link link" href="#" target="_blank">
							Мои задачи
						</a>
					</li>
					<li>
				...
				<span className="login">
					<a className="login__item link" href="#">
						Войти
					</a>
					/
					<a className="login__item link" href="#">
